              ...
              <div className="input-field">
                {Array.from({ length: 5 }, (_, index) => (
                  <input
                    ...
                    /* onKeyDown={(e) => handleCodeDelete(index, e)} */
        ...
        {isLogInPage ? (
          <>
            ...
            <div className='AuthorizationBtn'>
              <button className='LogBtn active' onClick={handleLogClick}>Войти</button>
            </div>
          </>
        ) : (
          <>
            ...
            <div className="form">
              ...
              <input type='password' placeholder='Password' name='rPassword' value={formData.rPassword} onChange={handleInputChange} style={formDataErrors.rPassword ? { border: "2px solid red" } : {}} />
              <label className="form-ur">
                <input className="UrLico" type="checkbox" name="legalEntity" checked={formData.legalEntity} onChange={handleInputChange} />
            ...
            <div className='AuthorizationBtn'>
              {isResendButtonActive ? (
                <>
                  <button className='RegBtn active' onClick={handleResendClick}>Отправить код повторно</button>
                  <button className='RegBtn' onClick={handleResendClick}>Создать другой аккаунт</button>
                </>
              ) : (
